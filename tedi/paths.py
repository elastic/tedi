...
class Paths(object):
    ...
    def make_render_path(self, path_to_template_file, suffix='default'):
        ...
        If suffix is specified and is not "default", it is added like this:
        ...
        if not suffix == 'default' and trailing_components:
